...
from dependencies.dependencies import get_hotel_service, get_current_user
...
@router.get(
    "/findHotelById/{hotel_id}",
    dependencies=[Depends(get_current_user)],
    response_model=HotelGetResponse,
)
