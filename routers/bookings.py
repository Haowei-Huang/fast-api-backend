...
from dependencies.dependencies import get_booking_service
...
@router.get("/findAllBookings", response_model=BookingListResponse)
...
@router.get("/findBookingByUserId/{user_id}", response_model=BookingListResponse)
